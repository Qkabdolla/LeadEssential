//
//  NetworkingModuleCacheIntegrationTests.swift
//  NetworkingModuleCacheIntegrationTests
//
...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    private func save(_ feed: [FeedItem], with loader: LocalFeedLoader, file: StaticString = #filePath, line: UInt = #line) {
        do {
    ...
    private func expect(_ sut: LocalFeedLoader, toLoad expectedFeed: [FeedItem], file: StaticString = #filePath, line: UInt = #line) {
        do {
