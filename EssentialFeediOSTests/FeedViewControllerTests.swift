...
//
//  Created by Каспи on 20.04.2023.
//
...
final class FeedViewControllerTests: XCTestCase {
    ...
    private func makeImage(description: String? = nil, location: String? = nil, url: URL = URL(string: "http://any.com")!) -> FeedItem {
        return FeedItem(id: UUID(), description: description, location: location, imageURL: url)
    }
    
    private func assertThat(_ sut: FeedViewController, isRendering feed: [FeedItem], file: StaticString = #filePath, line: UInt = #line) {
    ...
    private func assertThat(sut: FeedViewController, hasViewConfiguredFor image: FeedItem, at index: Int, file: StaticString = #file, line: UInt = #line) {
